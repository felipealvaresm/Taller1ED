...
public class Main {
    ...
    public static void mostrar(Vectores vector) {
        for (int i = 0; i < vector.getMax(); i++) {
            System.out.println("Nombre: " + vector.getVectorPersona()[i].getNombre() + ", Apellido: "
                    + vector.getVectorPersona()[i].getApellido() +
                    ", Estatura: " + vector.getVectorPersona()[i].getEstatura() + ", Peso: "
                    + vector.getVectorPersona()[i].getPeso());
        }
    }
}
